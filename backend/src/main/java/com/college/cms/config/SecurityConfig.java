    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
            ...
            .authorizeHttpRequests(auth -> auth
                ...
                // GET requests open to all authenticated users
                ...
                // Faculty + Admin for uploads/announcements POST
                .requestMatchers(HttpMethod.POST, "/api/materials/**").hasAnyRole("FACULTY", "ADMIN")
                .requestMatchers(HttpMethod.PUT, "/api/materials/**").hasAnyRole("FACULTY", "ADMIN")
                .requestMatchers(HttpMethod.DELETE, "/api/materials/**").hasAnyRole("FACULTY", "ADMIN")
